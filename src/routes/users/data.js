export const data = [
  {
    ...
    description:
      'Described by one witness as "possessing arms and dangerous", the Xcessive Overlord knows when to cut and run. Sharing battle stories thinly veiled as fortnightly email marketing drivel, the Overlord now works for the mafia as a delivery driver. Information of his underlying motives is sparse, some say he receives infrequent instructions via dead drop.'
  },
  {
  ...
  },
  {
    ...
    position: "['Full-stack Developer', 'Stick Artist']",
    skills: "['NodeJS', 'Cloud Functions']",
    special: [
      {
        key: "Neuron Count",
        value: "Nominal"
    ...
    description: `The journey to Atlantis is one way, which is why the Mad Desperado bought fourteen tickets from an unnamed Dark Web service in 2011. Winner of the inaugural Holochain Meme Hour in his very first week on the job, the Desperado is firmly positioned to reap the long term health benefits of Flex-flavoured fruit.`
  },
  {
